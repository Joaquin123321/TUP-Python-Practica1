...
# COMPLETAR - INICIO
cadena = variable_01 + variable_02 + variable_03
# print(cadena)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
cadena = variable_01 + str(variable_02) + variable_03
# print(cadena)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
cadena = "{0}{1}{2}{1}{3} Se llama {4}".format(variable_01, variable_02, variable_03, variable_04, variable_05)
# print(cadena)
# COMPLETAR - FIN

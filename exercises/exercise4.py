...
# COMPLETAR - INICIO
resultado = int(numero_01) + int(numero_02) + int(numero_03) + int(numero_04)
# print(resultado)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
concatenados = str(numero_01) + str(numero_02) + str(numero_03)
# print(concatenados)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
multiplicacion = int(numero_binario, 2) * int(numero_octal, 8) * int(numero_hexadecimal, 16)
